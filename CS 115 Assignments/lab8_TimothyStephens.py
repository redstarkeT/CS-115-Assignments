...
# Input: n
# Assume r >= 0
#Output: up to the nth Fibonacci number
#

#r1 is unput, r2 is first number, r3 is going to be the second number,
#r4 is sum of r2 and r3.

0     read      r1         # reads r1's input value
1     setn      r2 0       # sets r2 = 0
2     setn      r3 1       # sets r3 = 1
3     jeqzn     r1 10      # when r1 = 0, ends the program
4     write     r2         # writes the value of r2
5     add       r4 r2 r3   # adds r2 and r3 and sets it to r4
6     copy      r2 r3      # copies value of r3 to r2
7     copy      r3 r4      # copies value of r4 to r3
8     addn      r1 -1      # subtracts 1 from  counter:r1
9     jumpn     3          # jumps to step 3
10    halt                 # ends loop
"""
