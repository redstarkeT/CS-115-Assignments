...
def FA(x,y,cin):
    ...
    return (carry_out(x,y,cin),suum(x,y,cin)) #JUST PLACEHOLDERS
...
def fourBitAdd(xxxx,yyyy):
    ...
    (c,zo) = FA(xxxx[0],yyyy[0],c)
    return (c, (zo, zt, zf, ze))
...
def test_fourBitAdd():
    ...
    assert(c==1 and ww==(0,1,0,0))
    print("test_twoBitAdd valid (but incomplete testrun)")
